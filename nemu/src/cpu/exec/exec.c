...
opcode_entry opcode_table [512] = {
  ...
  /* 0x08 */	IDEXW(G2E,or,1), IDEX(E2G,or), IDEXW(E2G,or,1), IDEX(E2G,or),
  ...
  /* 0xe8 */	IDEX(J,call),  IDEXW(J,jmp,2), EMPTY, IDEXW(J,jmp,1),
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEXW(mov_E2G,movzx,1), IDEXW(mov_G2E, movzx, 1),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEXW(mov_E2G, movsx, 1), IDEXW(mov_G2E, movsx, 1),
